...
extern "C" void set_thread_count(int thread_count)
{
    ::thread_count = thread_count;
}

extern "C" int get_thread_count()
{
    return thread_count;
}

/* extern "C" void print_double_array(double* array, int length)
{
...
extern "C" int cg_least_squares_from_python(
...
extern "C" int cg_least_squares2_from_python(
    // instead of SparseMatrix* A
    int A_rows, int A_cols, int* A_row_indices, int* A_col_indices,
    double* A_values,
...
// Wrapper around "als(...)"
extern "C" int als_from_python(int* user_ids, int* item_ids,
